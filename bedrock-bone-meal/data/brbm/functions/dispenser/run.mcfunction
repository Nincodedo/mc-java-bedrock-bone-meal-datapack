...
execute if entity @s[tag=face_north] positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:sugar_cane run function brbm:sugar_cane/count_column
execute if entity @s[tag=face_south] positioned ~ ~ ~1 if block ~ ~ ~ minecraft:sugar_cane run function brbm:sugar_cane/count_column
